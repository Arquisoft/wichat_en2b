...
The deployment url is: [https://arquisoft.github.io/wichat_en2b/](https://arquisoft.github.io/wichat_en2b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_en2b/](https://arquisoft.github.io/wichat_en2b/), we need to execute `npm run deploy`.
