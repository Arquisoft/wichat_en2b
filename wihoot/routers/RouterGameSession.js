...
module.exports = (ioInstance) => {
    ...
    router.post("/:code/join", async (req, res) => {
        try {
            ...
            try {
                ...
                if (ioInstance) {
                    ioInstance.to(code).emit("player-joined", {
                        playerId: playerId,
                        username: username,
                        isGuest: !!isGuest,
                    })
    ...
    router.get("/:code/start", async (req, res) => {
        try {
            ...
            try {
                ...
                ioInstance.to(code).emit("session-started", {
    ...
    router.get("/:code/next", async (req, res) => {
        try {
            ...
            try {
                ...
                ioInstance.to(code).emit("question-changed", {
    ...
    router.post("/:code/answer", async (req, res) => {
        try {
            ...
            ioInstance.to(code).emit("answer-submitted", {
                playerId,
    ...
    router.get("/:code/end", async (req, res) => {
        try {
            ...
            try {
                ...
                ioInstance.to(code).emit("session-ended", {
                    players: session.players.map((p) => ({
                        id: p.id,
                        username: p.username,
                        isGuest: p.isGuest,
